...
def test_open_vwologin():
    ...
    # I that browser, we can open new tabs, open url, those will be different from the normal browser, and we can
    # perform our automation. After that it basically delete it. We delete that profile if it's not needed.
    # The moment you close this browser, everything gets deleted but a fresh copy will be created of browser everytime.
